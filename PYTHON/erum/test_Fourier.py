...
class TestTrigonoIdentity(unittest.TestCase):
    def test_TrigonometricEqual(self):
        self.assertEqual(plot_graph(1),(0.8414709848078965,0.5403023058681397,1.5574077246549023))
        self.assertEqual(plot_graph(0),(0,1,0))
        self.assertEqual(plot_graph(3.142),(-0.00040734639894142617,-0.9999999170344522,0.00040734643273714614))
